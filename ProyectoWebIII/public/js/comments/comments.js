...
const badWords = ["Malparido", "Puta", "Picha", "hp", "hijo de puta", "hija de puta", "chata", "panocha", "mierda", "playo"];
...
btnSaveComment.addEventListener("click", function () {
  ...
  // Censor bad words in the comment text
  const censoredCommentText = censorBadWords(commentText.value);

  // Create an object with the comment data
  const commentData = {
    commentText: censoredCommentText,
